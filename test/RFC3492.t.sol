...
contract Test_RFC3492 is Test {
	...
	function test_encode_xn__989aomsvi5e83db1d2a355cv1e0vak1dwrv93d5xbh15a0dt30a5jpsd879ccm6fea98c() public {
	...
	// Russian (Cyrillic)
	function test_decode_xn__b1abfaaepdrnnbgefbaDotcwatmq2g4l() public {
		assertEq(unicode"почемужеонинеговорятпорусски", Punycode.decode("xn--b1abfaaepdrnnbgefbaDotcwatmq2g4l"));
	}
	function test_encode_xn__b1abfaaepdrnnbgefbaDotcwatmq2g4l() public {
	...
	function test_decode_xn__PorqunopuedensimplementehablarenEspaol_fmd56a() public {
	...
	function test_encode_xn__PorqunopuedensimplementehablarenEspaol_fmd56a() public {
	...
	function test_decode_xn__TisaohkhngthchnitingVit_kjcr8268qyxafd2f1b9g() public {
		assertEq(unicode"TạisaohọkhôngthểchỉnóitiếngViệt", Punycode.decode("xn--TisaohkhngthchnitingVit-kjcr8268qyxafd2f1b9g"));
	}
	function test_encode_xn__TisaohkhngthchnitingVit_kjcr8268qyxafd2f1b9g() public {
	...
	function test_decode_xn__Hello_Another_Way__fc4qua05auwb3674vfr0b() public {
		assertEq(unicode"Hello-Another-Way-それぞれの場所", Punycode.decode("xn--Hello-Another-Way--fc4qua05auwb3674vfr0b"));
	}
	function test_encode_xn__Hello_Another_Way__fc4qua05auwb3674vfr0b() public {
